"""Shared helpers for chapter 10 compression examples."""
...
def add_common_arguments(parser: argparse.ArgumentParser, output_name: str) -> None:
    parser.add_argument("--input", type=Path, default=SAMPLE_GRAY)
...
def print_result(source: Path, operation: str, output: Path, metric: str | None = None) -> None:
